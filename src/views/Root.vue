			...
			>
				<div v-if="showModal === 'step1'">
					...
					<div class="pt-5 px-8">
						...
						<p class="text-dark">
							...
							account if for business, a pet, or something else.
						</p>
						<div class="w-full bg-lightblue border-b-2 border-dark mb-8 p-2">
							<input
								v-model="birthdate"
						...
						<p>
							By signing up, you agree to our <a href="#" class="text-blue">Terms</a>,
				...
				<div v-if="showModal === 'step2'">
					<div class="pl-1 pr-4 py-1 h-12">
						...
						<i class="flex justify-center fab fa-twitter text-blue text-2xl"></i>
					</div>
					<div class="pt-5 px-8">
						<div class="flex justify-between items-center pb-8">
						...
						<div class="mt-5 mb-5">
							...
							<div class="flex justify-between items-top">
								<p>
									...
									When this setting is enabled, Twitter may further personalise ads
				...
				<div v-if="showModal === 'step3'">
					<div class="pl-1 pr-4 py-1 h-12">
						...
						<button
							...
							class="rounded-full bg-blue font-bold text-white mt-2 p-1 pl-3 pr-3 relative right-0 float-right hover:bg-darkblue"
							:class="`${password.length < 8 ? 'opactiy-50 cursor-not-allowed' : ''}`"
						>
							Next
						</button>
						<i class="flex justify-center fab fa-twitter text-blue text-2xl"></i>
					...
					<div class="pt-5 px-8">
						...
						<p class="text-dark mb-4">Make sure it's 8 characters or more.</p>
						...
						<button @click="revealPassword = !revealPassword" class="text-blue pl-2">
							Reveal password
						</button>
					</div>
				</div>
				...
				<div v-if="showModal === 'step5'">
					<div class="pl-1 pr-4 py-1 h-12">
						<button
							...
							class="rounded-full bg-blue font-bold text-white mt-2 p-1 pl-3 pr-3 relative right-0 float-right hover:bg-darkblue"
							:class="`${!verificationCode ? 'opacity-50 cursor-not-allowed' : ''}`"
						>
							Next
						</button>
						<i
